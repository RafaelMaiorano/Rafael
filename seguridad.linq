...
//	.Where(loc => loc.Nombre.ToLower().Contains("rosario"))      //metodo de extension where con una funcion lambda como predicado
	.Select(loc => new { loc.IDLocalidad, loc.Nombre, loc.CodigoPostal} )		//metodo de extension Select con una funcion lambda como predicado
	.Dump();    												
														    //
...
public class Database
{
  ...
  public Database()
  {
    _tiposContacto = new List<TipoContacto>() 
    {
      ...
      new TipoContacto() { IDTipoContacto = 2, Descripcion = "Correo Electronico",        RegExp = @"^\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$" },
      new TipoContacto() { IDTipoContacto = 3, Descripcion = "Telefono Fijo Particular",  RegExp= "tel_fijo" },
      new TipoContacto() { IDTipoContacto = 4, Descripcion = "Telefono Fijo Laboral",     RegExp= "tel_fijo" },
      new TipoContacto() { IDTipoContacto = 5, Descripcion = "Telefono Movil Particular", RegExp = "tel_movil" },
 ...
 //  
  	_personas = new List<Persona>() {
		new Persona() { IdPersona = 1, Apellido = "Maiorano", Nombres = "Rafael", Domicilio = "Mozart 1079", AmpliacionDomicilio= "Pasaje", Localidad = "Rosario", CodigoPostal = 2000},
 //    	new Persona() { IdPersona = 2, Apellido = "Thedy", Nombres = "Enrique", Domicilio = "Mitre 515",  AmpliacionDomicilio= "5 Piso", Localidad = "Cabeza de Chancho" }
 //   	new Persona() { IdPersona = 3, Apellido = "Marques", Nombres = "Cristian", Domicilio = "Sarmiento 2145",  AmpliacionDomicilio= "XX", Localidad = "Roldan"},
 //    	new Persona() { IdPersona = 4, Apellido = "Almada", Nombres = "Luciano", Domicilio = "Mendoza 4245",  AmpliacionDomicilio= "yy", NomLocalidad = "Rosario" },
 //    	new Persona() { IdPersona = 5, Apellido = "Contesti", Nombres = "Carlos", Domicilio = "San Martin 445",  AmpliacionDomicilio= "zz", NomLocalidad = "Timbues"}
							};
